                ...
                >
                  <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                      <Text style={[styles.modalText, style.heading3]}>{modalObject.name}</Text>
                      ...
                      <Text style={[styles.modalText, style.baseText]}>{modalObject.description}</Text>
                      
                      <Pressable
                        style={[styles.button, styles.buttonClose]}
                        onPress={() => closeModal()}
                      >
                        <Text style={[style.baseText, styles.textStyle ]}>Ta en bild</Text>
                      </Pressable>
                    </View>
                  </View>
                </Modal>
                            ...
                            <CustomMarker item={obj} near={isNear(obj)}/>
                               <Callout>
                                <View style={styles.card}>
                                    <Text style={[style.heading6, styles.calloutText]}>{obj.category}</Text>
                                </View>
                              </Callout>
                          </Marker>
                        </View>
